...
DB_PATH = Path.home() / ".aria_sessions.db"
HISTORY_FILE = Path.home() / ".aria_prompt_history"
...
def print_aria_streaming(session_id: str, history: list) -> tuple[str, int, int, int]:
...
def main():
    ...
    while True:
        ...
        try:
            reply, tokens_in, tokens_out, latency_ms = print_aria_streaming(session_id, history)
