...
const GREETING: Message = {
  role: "assistant",
  content: "IRIS online. Integrated Risk Insight System — Ghost99RT. Ask anything about AI security, TrustScan results, or OWASP LLM Top 10.",
};
...
export default function IrisChat() {
  ...
  async function sendMessage() {
    ...
    try {
      ...
      const reply: Message = {
        role: "assistant",
        content: data.reply ?? "IRIS encountered an error. Try again.",
      };
          ...
          >
            <div style={{ display: "flex", alignItems: "center", gap: "0.5rem" }}>
              ...
              <span style={{ fontSize: "0.6rem", color: "var(--text-subtle)", letterSpacing: "0.05em" }}>
                Integrated Risk Insight System
              </span>
            </div>
            <div style={{ display: "flex", alignItems: "center", gap: "0.5rem" }}>
              <button
